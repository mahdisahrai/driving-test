...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ColorStateList itemTextColor = a.hasValue(C0012R.styleable.NavigationView_itemTextColor) ? a.getColorStateList(C0012R.styleable.NavigationView_itemTextColor) : null;
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0288R.attr.colorPrimary, value, true)) {
            return null;
        }
