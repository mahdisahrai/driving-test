...
public class TransitionManager {
    ...
    /* renamed from: go */
    public static void m3go(@NonNull Scene scene) {
        sImpl.mo1643go(scene.mImpl);
    }

    /* renamed from: go */
    public static void m4go(@NonNull Scene scene, @Nullable Transition transition) {
        sImpl.mo1644go(scene.mImpl, transition == null ? null : transition.mImpl);
    }
