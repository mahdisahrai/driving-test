...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0288R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0288R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0288R.styleable.TextAppearance_android_textColor);
            ta.recycle();
    ...
    /* access modifiers changed from: package-private */
    public void setScrollAnimatorListener(ValueAnimatorCompat.AnimatorListener listener) {
        ensureScrollAnimator();
