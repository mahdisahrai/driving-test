...
class FragmentTransition {
    ...
    private static void addToFirstInLastOut(BackStackRecord transaction, BackStackRecord.C0102Op op, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isPop, boolean isOptimizedTransaction) {
        boolean setFirstOut;
        boolean setLastIn;
