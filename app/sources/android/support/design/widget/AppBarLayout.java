...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(C0012R.styleable.AppBarLayout_elevation)) {
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[1] = (!this.mCollapsible || !this.mCollapsed) ? -C0012R.attr.state_collapsed : C0012R.attr.state_collapsed;
