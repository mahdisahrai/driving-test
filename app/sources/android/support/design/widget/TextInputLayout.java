...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0012R.styleable.TextInputLayout_passwordToggleTintMode)) {
            ...
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0012R.styleable.TextInputLayout_passwordToggleTintMode, -1), (PorterDuff.Mode) null);
        }
        a.recycle();
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.mErrorView.setId(C0012R.C0014id.textinput_error);
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0288R.style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0012R.color.design_textinput_error_color_light));
                }
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                this.mCounterView.setId(C0012R.C0014id.textinput_counter);
                if (this.mTypeface != null) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0288R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0012R.color.design_textinput_error_color_light));
                }
