    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0288R.C0290id.topPanel) {
                    topPanel = child;
                } else if (id == C0288R.C0290id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0288R.C0290id.contentPanel && id != C0288R.C0290id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
