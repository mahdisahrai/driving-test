...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0288R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, C0288R.styleable.AlertDialog, C0288R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0288R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0288R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0288R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0288R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0288R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0288R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0288R.styleable.AlertDialog_showTitle, true);
        a.recycle();
    ...
    private void setupView() {
        View spacer;
        View spacer2;
        View parentPanel = this.mWindow.findViewById(C0288R.C0290id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0288R.C0290id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0288R.C0290id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0288R.C0290id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0288R.C0290id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0288R.C0290id.topPanel);
        View customContentPanel = customPanel.findViewById(C0288R.C0290id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0288R.C0290id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null || (spacer2 = contentPanel.findViewById(C0288R.C0290id.textSpacerNoButtons)) == null)) {
        ...
        if (hasTopPanel) {
            ...
            if (!(this.mMessage == null && this.mListView == null && !hasCustomPanel) && !hasCustomPanel) {
                divider = topPanel.findViewById(C0288R.C0290id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (!(contentPanel == null || (spacer = contentPanel.findViewById(C0288R.C0290id.textSpacerNoTitle)) == null)) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0288R.C0290id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0288R.C0290id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0288R.C0290id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0288R.C0290id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0288R.C0290id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0288R.C0290id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0288R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0288R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0288R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
