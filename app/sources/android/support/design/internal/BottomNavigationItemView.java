...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundResource(C0012R.C0013drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0012R.C0014id.icon);
        this.mSmallLabel = (TextView) findViewById(C0012R.C0014id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0012R.C0014id.largeLabel);
    }
