...
import android.support.p003v7.recyclerview.C0291R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0291R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0291R.styleable.RecyclerView_layoutManager);
            if (a2.getInt(C0291R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0291R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0291R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0291R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0291R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0291R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
