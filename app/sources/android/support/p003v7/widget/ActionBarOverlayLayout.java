...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0288R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0288R.C0290id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0288R.C0290id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0288R.C0290id.action_bar));
        }
    }
